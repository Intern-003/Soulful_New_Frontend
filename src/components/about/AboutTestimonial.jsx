...
// components/about/AboutTestimonial.jsx
const AboutTestimonial = () => {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6 italic">
              "SoulfulOverseas transformed my small jewelry business. The
              multi-vendor tools are intuitive, and I've reached customers I
              never thought possible. Truly a game-changer for artisans like
              me."
            </p>
            <div className="flex items-center gap-4">
              <img
                ...
                alt="Anjali Sharma"
                className="w-14 h-14 rounded-full object-cover ring-2 ring-[#f1d6dd]"
              />
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Jewelry Designer, Jaipur
                </p>
                <p className="text-xs text-[#7a1c3d] mt-1">Seller since 2023</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-gray-100">
            ...
            <p className="text-gray-700 text-lg leading-relaxed mb-6 italic">
              "As a buyer, I love discovering unique products from different
              vendors all in one place. Shipping is reliable, and the quality
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Loyal Customer, Singapore
                </p>
                <p className="text-xs text-[#7a1c3d] mt-1">15+ orders placed</p>
              </div>
            </div>
          </div>
        </div>
