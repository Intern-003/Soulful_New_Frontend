...
/* ==========================================================
   ...
   FIXED: Proper image handling with getImageUrl
========================================================== */

const ProductPreview = ({ products = [], onRemove }) => {
  ...
  if (!products.length) {
    return (
      <section className="rounded-3xl border border-dashed border-slate-300 bg-white px-6 py-12 text-center shadow-sm">
        ...
        <h3 className="mt-4 text-lg font-semibold text-slate-900">No Products Selected</h3>
        <p className="mt-2 text-sm text-slate-500">Select products to attach them with this banner.</p>
      </section>
    );
  }
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="border-b border-slate-100 px-5 py-4">
        <h3 className="text-sm font-semibold text-slate-900">Selected Products ({products.length})</h3>
        <p className="mt-1 text-xs text-slate-500">These products will appear in linked layouts.</p>
      </div>
