          ...
          <tbody className="divide-y divide-slate-100">
            ...
            {!loading &&
              ...
              categories.map((item) => {
                ...
                // ✅ Fix: Move image logic outside useMemo
                ...
                return (
                  <tr key={item.id} className="transition hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4">
                      <Badge
                        icon={active ? <CheckCircle2 size={14} /> : <XCircle size={14} />}
                        text={active ? "Active" : "Inactive"}
                        color={active ? "emerald" : "rose"}
                      />
                    </td>
...
const Th = ({
  ...
  <th
    className={`whitespace-nowrap px-6 py-4 text-xs font-semibold uppercase tracking-wider text-slate-500 ${align ===
        "right"
        ? "text-right"
        : "text-left"
      }`}
