      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <div className="p-6 sm:p-8">
            ...
            {/* Google */}
            <button className="w-full flex items-center justify-center gap-2 border border-gray-300 py-2.5 rounded-md hover:bg-gray-50 transition">
